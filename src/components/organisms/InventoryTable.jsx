...
const getStockStatus = (quantity, minStock) => {
    if (quantity <= 0) return { status: t('outOfStock'), variant: "error" };
    if (quantity <= minStock) return { status: t('lowStock'), variant: "warning" };
    return { status: t('inStock'), variant: "success" };
  };
                        ...
                        <tr key={item.Id} className="hover:bg-gray-50 transition-colors">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                                <div className="w-full bg-gray-200 rounded-full h-2">
                                    <div
                                        className={`h-2 rounded-full transition-all duration-300 ${stockPercentage > 50 ? "bg-gradient-to-r from-success to-green-600" : stockPercentage > 20 ? "bg-gradient-to-r from-warning to-yellow-600" : "bg-gradient-to-r from-error to-red-600"}`}
                                        style={{
